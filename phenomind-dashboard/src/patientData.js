// Patient data structure with EHR records, wearables, and psychiatric disorders

// Helper function to generate trend data for each patient
function generateTrendData(baseMood, baseSleep, baseHRV, baseActivity, moodTrend, sleepTrend, hrvTrend, activityTrend) {
  ...
  return days.map((d, i) => ({
    day: d,
    mood: Math.max(0, Math.min(100, baseMood + Math.sin(i / 4) * 10 + (moodTrend * i / 30))),
    sleep: Math.max(4, Math.min(10, baseSleep + Math.sin(i / 5) * 0.6 + (sleepTrend * i / 30))),
    hrv: Math.max(20, Math.min(80, baseHRV + Math.cos(i / 6) * 8 + (hrvTrend * i / 30))),
    activity: Math.max(2000, baseActivity + Math.sin(i / 3) * 1500 + (activityTrend * i / 30)),
  }));
}
...
export const patients = [
    {
      ...
      initials: "JD",
      disorder: "MDD",
      disorderFull: "Major Depressive Disorder",
      medications: ["Sertraline 75mg"],
      ...
      trendData: generateTrendData(60, 7, 45, 7000, -6, -0.8, -6, -2200)
    },
    {
      id: 2,
      name: "Michael Chen",
      ...
      initials: "MC",
      disorder: "Bipolar I",
      disorderFull: "Bipolar I Disorder",
      ...
      trendData: generateTrendData(45, 5.2, 35, 12400, 8, -2.3, -10, 3500)
    },
    {
      id: 3,
      name: "Sarah Williams",
      ...
      initials: "SW",
      disorder: "PTSD",
      disorderFull: "Post-Traumatic Stress Disorder",
      ...
      trendData: generateTrendData(70, 7.8, 52, 8900, -3, 0.5, 4, -500)
    },
    {
      id: 4,
      ...
      initials: "DR",
      disorder: "GAD",
      disorderFull: "Generalized Anxiety Disorder",
      medications: ["Escitalopram 20mg", "Buspirone 15mg"],
      ...
      trendData: generateTrendData(75, 6.8, 48, 7200, -2, -0.2, -2, -300)
    },
    {
      id: 5,
      name: "Emily Thompson",
      ...
      initials: "ET",
      disorder: "OCD",
      disorderFull: "Obsessive-Compulsive Disorder",
      medications: ["Fluoxetine 40mg", "Clomipramine 75mg"],
      ...
      trendData: generateTrendData(65, 7.2, 46, 8500, -3, 0.3, 2, 200)
    },
    {
      id: 6,
      name: "James Wilson",
      ...
      disorderFull: "Schizophrenia, Paranoid Type",
      medications: ["Risperidone 4mg", "Aripiprazole 15mg"],
      ...
      trendData: generateTrendData(50, 6.5, 38, 6800, 2, -0.5, -4, -500)
    },
    {
      id: 7,
      ...
      initials: "OM",
      disorder: "BPD",
      disorderFull: "Borderline Personality Disorder",
      ...
      trendData: generateTrendData(55, 6.8, 44, 9200, 1, -0.1, -2, 300)
    },
    {
      id: 8,
      name: "Robert Kim",
      ...
      disorderFull: "Panic Disorder with Agoraphobia",
      medications: ["Paroxetine 30mg", "Alprazolam 0.5mg"],
      ...
      trendData: generateTrendData(70, 7.5, 50, 7800, -2, 0.2, 2, -100)
    },
    {
      id: 9,
      ...
      disorderFull: "Social Anxiety Disorder",
      medications: ["Sertraline 100mg", "Propranolol 40mg"],
      ...
      trendData: generateTrendData(75, 7.9, 54, 10200, -1, 0.1, 2, 500)
    },
    {
      id: 10,
      ...
      initials: "CL",
      disorder: "ADHD",
      disorderFull: "Attention-Deficit/Hyperactivity Disorder",
      medications: ["Methylphenidate 36mg", "Atomoxetine 40mg"],
      lastVisit: "1 day ago",
      riskScore: 35,
      ehr: {
      ...
      trendData: generateTrendData(80, 7.0, 49, 11500, -1, -0.1, 2, 800)
    },
    {
      id: 11,
      ...
      initials: "IG",
      disorder: "Anorexia",
      disorderFull: "Anorexia Nervosa",
      medications: ["Fluoxetine 60mg", "Olanzapine 5mg"],
      ...
      trendData: generateTrendData(50, 6.5, 32, 15200, 3, -0.3, -3, 2000)
    },
    {
      id: 12,
      name: "Daniel Brown",
      ...
      disorderFull: "Substance Use Disorder (Alcohol)",
      medications: ["Naltrexone 50mg", "Acamprosate 666mg"],
      ...
      trendData: generateTrendData(65, 6.2, 40, 9500, -2, 0.4, 2, 600)
    }
  ];
